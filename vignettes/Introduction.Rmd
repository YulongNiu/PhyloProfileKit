...
where $\overline{X}$ and $\overline{Y}$ are the sample mean of $X$ and $Y$, and $S_X$ and $S_Y$ are the sample standard deviations of $X$ and $Y$, respectively.
...
where $p(x, y)$ is the joint probability density function of $X$ and $Y$, $p(x)$ and $p(y)$ is the marginal probability density function of $X$ and $Y$, respectively.

* `method = 'DistHamming'` for Hamming distance 
